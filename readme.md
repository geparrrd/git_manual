...
делиться своими идеями, предлагать свои, а также даёт возможность работать над проектом в команде.
...
Готово! Проверьте наличие ключей с помощью команды `ls -a ~/.ssh`. На экране
